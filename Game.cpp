...
void Game::loadTextures()
{
    ...
    texmgr.loadTexture("mountain",      "media/mountain.png");
    ...
    texmgr.loadTexture("pylon",         "media/pylon.png");
...
void Game::loadTiles()
{
    ...
    tileAtlas["mountain"] =
            Tile(this->tileSize, 1, texmgr.getRef("mountain"),
                 { staticAnim },
                 TileType::MOUNTAIN, 50, 0, 1);
    tileAtlas["forest"] =
    ...
    tileAtlas["pylon"] =
            Tile(this->tileSize, 2, texmgr.getRef("pylon"),
                 { staticAnim, staticAnim, staticAnim,
                   staticAnim },
                 TileType::PYLON, 500, 50, 4);
    tileAtlas["road"] =
...
Game::Game()
{
    ...
    this->window.create(sf::VideoMode(800, 600), "DomiCity: The Demo");
