...
#ifndef DOMICITY_TILE_H
#define DOMICITY_TILE_H
...
enum class TileType { VOID, GRASS, FOREST, MOUNTAIN, WATER, RESIDENTIAL, COMMERCIAL, INDUSTRIAL, ROAD, PYLON };
